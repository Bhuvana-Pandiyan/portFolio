  ...
  return (
    <div className="bg-black text-white py-10" id="about">
      <div className="container mx-auto px-8 md:px-16 lg:px-14">
        ...
        <div className="flex flex-wrap justify-center md:justify-center gap-4 md:mb-0 md:w-1/4">
  {[
    ...
    <div
      key={index}
      className="p-[2px] rounded-lg bg-gradient-to-tr from-green-400 to-blue-500 hover:scale-105 transition-transform"
    >
